...
app.layout = html.Div(
        ...
        html.Div([
                ...
                dcc.Upload(
                    ...
                    html.P('This current prototype was supported by the National Science Foundation (NSF) (Award #1421935) and Coordenacao de Aperfeicoamento de Pessoal de Nivel Superior (CAPES) foundation (Process 88881.170553/2018-01).')
